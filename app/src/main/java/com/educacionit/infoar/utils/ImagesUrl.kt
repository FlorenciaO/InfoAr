package com.educacionit.infoar.utils

object ImagesUrl {
    fun getRandomImagenURLNoticia(): String {
        val urls = listOf(
            ...
            "https://plus.unsplash.com/premium_photo-1691223733678-095fee90a0a7?q=80&w=2121&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
